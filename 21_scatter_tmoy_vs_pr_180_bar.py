...
path_all2=('/tank/begin/weighting/E_2/traite/'+b_pt+'/'+var)
files_all2= []
...
path_all3=('/tank/begin/weighting/E_2/traite/'+b_pt+'/'+var)
files_all3= []
...
##################################################précipitation
#ouvrir tous les fichiers qui commence par stat1 
path_allp=('/tank/begin/weighting/E_2/traite/'+b_pt+'/'+var2)
files_allp= []
...
#ouvrir tous les fichiers qui commence par stat2 
path_all2p=('/tank/begin/weighting/E_2/traite/'+b_pt+'/'+var2)
files_all2p= []
...
#ouvrir tous les fichiers qui commence par stat3 
path_all3p=('/tank/begin/weighting/E_2/traite/'+b_pt+'/'+var2)
files_all3p= []
...
climex_tmoy=[];climex_pr=[]
cmip5_tmoy=[];cmip5_pr=[]
cordex_tmoy=[];cordex_pr=[]
plt.figure(1)
for i in position:
    ...
    if df1['groupe'][i]=='ClimEx':
        ...
        climex_tmoy.append(delta_tmoy)
        climex_pr.append(delta_pr)
    elif df1['groupe'][i]=='CMIP5':
        plt.scatter(delta_tmoy,delta_pr,c='b',marker='o',s=15)
        cmip5_tmoy.append(delta_tmoy)
        cmip5_pr.append(delta_pr)
    elif df1['groupe'][i]=='CORDEX'or'Ouranos':
        plt.scatter(delta_tmoy,delta_pr,c='r',marker='o',s=15)
        cordex_tmoy.append(delta_tmoy)
        cordex_pr.append(delta_pr)
        
#max_climex_tmoy=np.max(climex_tmoy)
#min_climex_tmoy=np.min(climex_tmoy)
max_cmip5_tmoy=np.max(cmip5_tmoy)
min_cmip5_tmoy=np.min(cmip5_tmoy)
max_cordex_tmoy=np.max(cordex_tmoy)
min_cordex_tmoy=np.min(cordex_tmoy)

#plt.plot([max_climex_tmoy,min_climex_tmoy],[-15,-15],color='grey',marker='d')
plt.plot([max_cmip5_tmoy,min_cmip5_tmoy],[-10,-10],color='b',marker='d')
plt.plot([max_cordex_tmoy,min_cordex_tmoy],[-10,-10],color='r',marker='d')

#max_climex_pr=np.max(climex_pr)
#min_climex_pr=np.min(climex_pr)
max_cmip5_pr=np.max(cmip5_pr)
min_cmip5_pr=np.min(cmip5_pr)
max_cordex_pr=np.max(cordex_pr)
min_cordex_pr=np.min(cordex_pr)

#plt.plot([1,1],[max_climex_pr,min_climex_pr],color='grey',marker='d')
plt.plot([0.5,0.5],[max_cmip5_pr,min_cmip5_pr],color='b',marker='d')
plt.plot([0.5,0.5],[max_cordex_pr,min_cordex_pr],color='r',marker='d')
...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_E_2_delta_ensemble_bar_2041_2070_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2041-2070\n'+saison[s]+'_'+rcp+' (E_2)\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_E_2_delta_ensemble_bar_2041_2070_'+rcp+'_'+saison[s],bbox_inches='tight')
...
#plt.plot([2,2],[max_climex_pr,min_climex_pr],color='grey',marker='d')
plt.plot([1,1],[max_cmip5_pr,min_cmip5_pr],color='b',marker='d')
plt.plot([1,1],[max_cordex_pr,min_cordex_pr],color='r',marker='d')
...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_E_2_delta_ensemble_bar_2071_2100_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2071-2100\n'+saison[s]+'_'+rcp+' (E_2)\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_E_2_delta_ensemble_bar_2071_2100_'+rcp+'_'+saison[s],bbox_inches='tight')
