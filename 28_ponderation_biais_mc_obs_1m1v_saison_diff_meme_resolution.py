...
if b_pt == 'brute':
    plt.title('Référence NRcan même résolution\n'+var+' moyenne climatique (E_1) 1971-2000_'+saison[s]+'_'+rcp+'\nBrutes',fontsize=15)
   # plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_E_1_b_pond_biais_mc_obs_1m1v_1971-2000_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Référence NRcan même résolution\n'+var+' moyenne climatique (E_1) 1971-2000_'+saison[s]+'_'+rcp+'\nPost-traitées',fontsize=15)
   # plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_E_1_pt_pond_biais_mc_obs_1m1v_1971-2000_'+saison[s]+'_'+rcp,bbox_inches='tight')
