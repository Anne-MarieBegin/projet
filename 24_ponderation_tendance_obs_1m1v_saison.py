...
var='tmoy'
stat1='30x4_1988_2017_'#référence
b_pt='posttraite'
s=3
...
for j in range(len(fit_da_all)):
    diff_moy_all.append(abs(fit_da_all[j]-fit_da_obs))
...
if b_pt=='brute':
    df_w_all_norm.to_csv('/tank/begin/weighting/resultats/pond_pente_tendance_1988_2017_obs_b_'+var+'_'+saison[s]+'_'+rcp+'.csv')
else:
    df_w_all_norm.to_csv('/tank/begin/weighting/resultats/pond_pente_tendance_1988_2017_obs_pt_'+var+'_'+saison[s]+'_'+rcp+'.csv')
#   
...
if b_pt == 'brute':
    plt.title('Poids référence NRcan\n'+var+' pente tendance (E_1) 1988-2017_'+saison[s]+'_'+rcp+'\nBrutes',fontsize=15)
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_E_1_b_pond_pente_tendance_obs_1m1v_1988-2017_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Poids référence NRcan\n'+var+' pente tendance (E_1) 1988-2017_'+saison[s]+'_'+rcp+'\nPost-traitées',fontsize=15)
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_E_1_pt_pond_pente_tendance_obs_1m1v_1988-2017_'+saison[s]+'_'+rcp,bbox_inches='tight')
