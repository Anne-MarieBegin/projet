...
for c in range(0,50):    
    ...
    if b_pt=='brute':
        df_w_all_norm.to_csv('/tank/begin/weighting/resultats/pond_diff_pente_'+climex_[c]+'_b_'+var+'_'+saison[s]+'_'+rcp+'.csv')
    else:
        df_w_all_norm.to_csv('/tank/begin/weighting/resultats/pond_diff_pente_'+climex_[c]+'_pt_'+var+'_'+saison[s]+'_'+rcp+'.csv')
#    
    ...
    if b_pt == 'brute':
        ...
        plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_E_1_b_pond_diff_pente_climex_1971-2000_'+saison[s]+'_'+rcp,bbox_inches='tight')
    else:
        plt.title('Poids référence ClimEx\n'+var+' pente tendance (E_1) 1971-2000 '+saison[s]+'_'+rcp+'\nPost-traitées',fontsize=15)
        plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_E_1_pt_pond_diff_pente_climex_1971-2000_'+saison[s]+'_'+rcp,bbox_inches='tight')
