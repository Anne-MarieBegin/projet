...
v20201217 cycle annuel,erreur absolue,rapport variance+coefficient corrélation
v20201222 cycle annuel, biais, rapport variance(corrigé)+coefficient corrélation (ajustement de l'échelle)
...
#calcul moy variance annual cycle
moy=[]
std=[]
...
#calcul rapport variance
rapport_std=[]
for i in range(0,len(files)+1):
    rapport_std.append(std[i]/std[0])
    
#coefficeint corrélation
cc=[]
...
#plot cycle annuel
plt.figure(1)
plt.plot(mois,da[0],'--k',zorder=13)
...
#plot rapport variance et coefficient corrélation 2 axes
