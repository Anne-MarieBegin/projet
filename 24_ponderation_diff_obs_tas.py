...
df_w_all_norm.to_csv('/tank/begin/weighting/resultats/pond_diff_obs_'+var+'.csv')
...
if b_pt == 'brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_E_1_b_pond_diff_obs_1971-2000',bbox_inches='tight')
else:
    plt.title('Poids référence RNcan\n'+var+' (E_1)1971-2000\nPost-traitées',fontsize=34)
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_E_1_pt_pond_diff_obs_1971-2000',bbox_inches='tight')
