...
#fichier avec résolution des simulations
reso=pd.read_csv('/tank/begin/weighting/resultats/resolution.csv')

df_all['reso']=reso['0']
df_all['gcm_reso']=df1['gcm']+'_'+reso['0'].map(str)

gcm_reso=np.unique(df_all['gcm_reso'])
