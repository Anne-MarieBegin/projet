...
#if b_pt=='brute':
#    df_w_all_norm.to_csv('/tank/begin/weighting/pond_combine/pond_exp_mc_obs_b_'+var+'_'+saison[s]+'_'+rcp+'.csv')
#else:
#    df_w_all_norm.to_csv('/tank/begin/weighting/pond_combine/pond_exp_mc_obs_pt_'+var+'_'+saison[s]+'_'+rcp+'.csv')
...
if b_pt == 'brute':
    ...
    #plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_E_1_b_pond_exp_mc_obs_1m1v_1971-2000_'+saison[s]+'_'+rcp+'_sa_al',bbox_inches='tight')
else:
    plt.title('Poids référence NRcan\n'+var+' moyenne climatique (E_1) 1971-2000_'+saison[s]+'_'+rcp+'\nPost-traitées\nsigma_d='+str(round(sigma_d,2)),fontsize=15)
    #plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_E_1_pt_pond_exp_mc_obs_1m1v_1971-2000_'+saison[s]+'_'+rcp+'_sa_al',bbox_inches='tight')
