...
#calcul du delta
delta_moy_pond_10000_1=(moy_pond_10000_2-moy_pond_10000_1)/moy_pond_10000_1*100
delta_moy_pond_10000_2=(moy_pond_10000_3-moy_pond_10000_1)/moy_pond_10000_1*100
...
#calcul du delta
delta_moy_pond_uniforme_1=(moy_pond_uniforme_2-moy_pond_uniforme_1)/moy_pond_uniforme_1*100
delta_moy_pond_uniforme_2=(moy_pond_uniforme_3-moy_pond_uniforme_1)/moy_pond_uniforme_1*100
#s pour saison
...
#calcul du delta
delta_moyenne_1=(moyenne_2-moyenne_1)/moyenne_1*100
delta_moyenne_2=(moyenne_3-moyenne_1)/moyenne_1*100
...
#calcul du delta
delta_moy_cmip5_1=(moy_cmip5_2-moy_cmip5_1)/moy_cmip5_1*100
delta_moy_cmip5_2=(moy_cmip5_3-moy_cmip5_1)/moy_cmip5_1*100
...
#calcul du delta
delta_moy_cordex_1=(moy_cordex_2-moy_cordex_1)/moy_cordex_1*100
delta_moy_cordex_2=(moy_cordex_3-moy_cordex_1)/moy_cordex_1*100
...
#calcul du delta
delta_moy_climex_1=(moy_climex_2-moy_climex_1)/moy_climex_1*100
delta_moy_climex_2=(moy_climex_3-moy_climex_1)/moy_climex_1*100
...
plt.plot(x,delta1,'-o',color='m',markersize=6)
plt.plot(x,delta2,'-o',color='b',markersize=6)
plt.plot(x,delta3,'-o',color='g',markersize=6)
plt.plot(x,delta4,'-o',color='c',markersize=6)
plt.plot(x,delta5,'-o',color='y',markersize=6)
plt.plot(x,delta6,'-o',color='r',markersize=6)
plt.legend(legend,fontsize=7)
plt.ylabel('Delta précipitation (%)')
if b_pt=='brute':
    plt.title(var+'_'+saison[s]+'_'+rcp+' (E_2)\nDelta par rapport à 1981-2010\nBrutes')
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_E_2_moy_pondere_delta_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title(var+'_'+saison[s]+'_'+rcp+' (E_2)\nDelta par rapport à 1981-2010\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_E_2_moy_pondere_delta_'+rcp+'_'+saison[s],bbox_inches='tight')
