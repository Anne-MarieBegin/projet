...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_TCR_VS_delta_'+stat2[-10:-1]+'_'+rcp,bbox_inches='tight')
else:
    plt.title(var+'\n'+stat2[-10:-1]+'_'+rcp+'\nCoefficient corrélation ='+str(round(cc[0][1],3))+'\nPost-traitées')  
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_TCR_VS_delta_'+stat2[-10:-1]+'_'+rcp,bbox_inches='tight')
...
if b_pt=='brute':
    plt.title(var+'\n'+stat3[-10:-1]+'_'+rcp+'\nCoefficient corrélation ='+str(round(cc[0][1],3))+'\nBrutes')
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_TCR_VS_delta_'+stat3[-10:-1]+'_'+rcp,bbox_inches='tight')
else:
    plt.title(var+'\n'+stat3[-10:-1]+'_'+rcp+'\nCoefficient corrélation ='+str(round(cc[0][1],3))+'\nPost-traitées')  
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_TCR_VS_delta_'+stat3[-10:-1]+'_'+rcp,bbox_inches='tight')
