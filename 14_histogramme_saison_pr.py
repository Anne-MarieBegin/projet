...
#plt.ylabel('Nombre (total '+str(len(data))+')')
##plt.ylim(0,45)
#plt.xlim(2.5,4.25)
#if b_pt=='brute':
...
#plt.ylim(0,30)
if b_pt=='brute':
    plt.title('Précipitation '+saison[s]+' \n'+rcp+'\n2041_2070-1981_2010\nBrutes')
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_E_1_hist_delta_'+rcp+stat2[3::]+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Précipitation '+saison[s]+'\n'+rcp+'\n2041_2070-1981_2010\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_E_1_hist_delta_'+rcp+stat2[3::]+'_'+saison[s],bbox_inches='tight')
...
if b_pt=='brute':
    plt.title('Précipitation '+saison[s]+' \n'+rcp+'\n2071_2100-1981_2010\nBrutes')
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_E_1_hist_delta_'+rcp+stat3[3::]+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Précipitation '+saison[s]+'\n'+rcp+'\n2071_2100-1981_2010\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_E_1_hist_delta_'+rcp+stat3[3::]+'_'+saison[s],bbox_inches='tight')
