...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_moy_pondere_delta_er_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title(var+'_'+saison[s]+'_'+rcp+'\nDelta par rapport à 1981-2010\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_moy_pondere_delta_er_'+rcp+'_'+saison[s],bbox_inches='tight')
