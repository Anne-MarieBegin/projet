...
######################################################################
if b_pt == 'brute':
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF_obs_b_tmoy_pr_'+rcp+'.csv')
else:
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF_obs_pt_tmoy_pr_'+rcp+'.csv')
...
delta_moy_pond_djf_1=moy_pond_diff_2-moy_pond_diff_1
delta_moy_pond_djf_2=moy_pond_diff_3-moy_pond_diff_1
...
delta_moy_pond_djf_1p=(moy_pond_diff_2p-moy_pond_diff_1p)/moy_pond_diff_1p*100
delta_moy_pond_djf_2p=(moy_pond_diff_3p-moy_pond_diff_1p)/moy_pond_diff_1p*100
######################################################################
if b_pt == 'brute':
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM_obs_b_tmoy_pr_'+rcp+'.csv')
else:
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM_obs_pt_tmoy_pr_'+rcp+'.csv')
...
delta_moy_pond_djfmam_1=moy_pond_diff_2-moy_pond_diff_1
delta_moy_pond_djfmam_2=moy_pond_diff_3-moy_pond_diff_1
...
delta_moy_pond_djfmam_1p=(moy_pond_diff_2p-moy_pond_diff_1p)/moy_pond_diff_1p*100
delta_moy_pond_djfmam_2p=(moy_pond_diff_3p-moy_pond_diff_1p)/moy_pond_diff_1p*100
######################################################################
if b_pt == 'brute':
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM+JJA_obs_b_tmoy_pr_'+rcp+'.csv')
else:
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM+JJA_obs_pt_tmoy_pr_'+rcp+'.csv')
...
delta_moy_pond_djfmamjja_1=moy_pond_diff_2-moy_pond_diff_1
delta_moy_pond_djfmamjja_2=moy_pond_diff_3-moy_pond_diff_1
...
delta_moy_pond_djfmamjja_1p=(moy_pond_diff_2p-moy_pond_diff_1p)/moy_pond_diff_1p*100
delta_moy_pond_djfmamjja_2p=(moy_pond_diff_3p-moy_pond_diff_1p)/moy_pond_diff_1p*100
######################################################################
if b_pt == 'brute':
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM+JJA+SON_obs_b_tmoy_pr_'+rcp+'.csv')
else:
    df_diff=pd.read_csv('/tank/begin/weighting/pond_combine/pond_mixte_mc_DJF+MAM+JJA+SON_obs_pt_tmoy_pr_'+rcp+'.csv')
...
delta_moy_pond_djfmamjjason_1=moy_pond_diff_2-moy_pond_diff_1
delta_moy_pond_djfmamjjason_2=moy_pond_diff_3-moy_pond_diff_1
...
delta_moy_pond_djfmamjjason_1p=(moy_pond_diff_2p-moy_pond_diff_1p)/moy_pond_diff_1p*100
delta_moy_pond_djfmamjjason_2p=(moy_pond_diff_3p-moy_pond_diff_1p)/moy_pond_diff_1p*100
...
legend=['moyenne non pondérée','moy pondérée_250000km²(5$\Delta$x)',
        ...
        'CMIP5','CORDEX','ClimEx','moy_pondérée_mixte_DJF_exp_mc_tmoy_pr_obs','moy_pondérée_mixte_DJF+MAM_exp_mc_tmoy_pr_obs'
        ,'moy_pondérée_mixte_DJF+MAM+JJA_exp_mc_tmoy_pr_obs','moy_pondérée_mixte_DJF+MAM+JJA+SON_exp_mc_tmoy_pr_obs'
        ]
...
plt.scatter(delta_moy_pond_djf_1,delta_moy_pond_djf_1p,color='hotpink')
plt.scatter(delta_moy_pond_djfmam_1,delta_moy_pond_djfmam_1p,color='brown')
plt.scatter(delta_moy_pond_djfmamjja_1,delta_moy_pond_djfmamjja_1p,color='orange')
plt.scatter(delta_moy_pond_djfmamjjason_1,delta_moy_pond_djfmamjjason_1p,marker='x',color='grey')
...
if b_pt=='brute':
   ...
   # plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_'+SE+'_delta_mixte_DJF+MAM+JJA+SON_tmoy_pr_2041_2070_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2041_2070\n'+saison[s]+'_'+rcp+' ('+SE+')\nPost-traitées')
   # plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_'+SE+'_delta_mixte_DJF+MAM+JJA+SON_tmoy_pr_2041_2070_'+saison[s]+'_'+rcp,bbox_inches='tight')
...
plt.scatter(delta_moy_pond_djf_2,delta_moy_pond_djf_2p,color='hotpink')
plt.scatter(delta_moy_pond_djfmam_2,delta_moy_pond_djfmam_2p,color='brown')
plt.scatter(delta_moy_pond_djfmamjja_2,delta_moy_pond_djfmamjja_2p,color='orange')
plt.scatter(delta_moy_pond_djfmamjjason_2,delta_moy_pond_djfmamjjason_2p,marker='x',color='grey')
...
if b_pt=='brute':
   ...
   # plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_'+SE+'_delta_mixte_DJF+MAM+JJA+SON_tmoy_pr_2071_2100_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2071-2100\n'+saison[s]+'_'+rcp+' ('+SE+')\nPost-traitées')
   # plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_'+SE+'_delta_mixte_DJF+MAM+JJA+SON_tmoy_pr_2071_2100_'+saison[s]+'_'+rcp,bbox_inches='tight')
