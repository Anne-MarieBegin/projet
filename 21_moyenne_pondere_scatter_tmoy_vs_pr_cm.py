...
legend=['moyenne non pondérée','moy pondérée_250000km²(5$\Delta$x)',
        ...
        'CMIP5','CORDEX','ClimEx','moy_pondérée_exp_moyenne_climatique_tmoy_obs_'+saison[s],'moy_pondérée_exp_pente_tmoy_obs_'+saison[s]
        ]
...
plt.scatter(delta_moy_pond_diff_pente_1,delta_moy_pond_diff_pente_1p,color='lightgrey')
...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_'+SE+'_delta_exp_mc+pente_tmoy_2041_2070_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2041_2070\n'+saison[s]+'_'+rcp+' ('+SE+')\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_'+SE+'_delta_exp_mc+pente_tmoy_2041_2070_'+saison[s]+'_'+rcp,bbox_inches='tight')
...
plt.scatter(delta_moy_pond_diff_pente_2,delta_moy_pond_diff_pente_2p,color='lightgrey')
...
if b_pt=='brute':
    ...
    plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_'+SE+'_delta_exp_mc+pente_tmoy_2071_2100_'+saison[s]+'_'+rcp,bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2071-2100\n'+saison[s]+'_'+rcp+' ('+SE+')\nPost-traitées')
    plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_'+SE+'_delta_exp_mc+pente_tmoy_2071_2100_'+saison[s]+'_'+rcp,bbox_inches='tight')
