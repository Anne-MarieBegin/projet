...
plt.figure(1)
delta1=[delta_moyenne_1,delta_moyenne_1p]
delta2=[delta_moy_pond_10000_1,delta_moy_pond_10000_1p]
delta3=[delta_moy_pond_uniforme_1,delta_moy_pond_uniforme_1p] 
delta4=[delta_moy_cmip5_1,delta_moy_cmip5_1p] 
delta5=[delta_moy_cordex_1,delta_moy_cordex_1p] 
delta6=[delta_moy_climex_1,delta_moy_climex_1p]       
legend=['moyenne non pondérée','moy pondérée_bassin<10000km²','moy pondérée_un modèle un vote uniforme','CMIP5','CORDEX']#,'ClimEx']

plt.scatter(delta1[0],delta1[1],color='m')
plt.scatter(delta2[0],delta2[1],color='b')
plt.scatter(delta3[0],delta3[1],color='g')
plt.scatter(delta4[0],delta4[1],color='c')
plt.scatter(delta5[0],delta5[1],color='y')
plt.scatter(delta6[0],delta6[1],color='r')
...
if b_pt=='brute':
   ...
   # plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_E_2_moy_pondere_delta_2041_2070_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2041_2070\n'+saison[s]+'_'+rcp+' (E_2)\nPost-traitées')
    #plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_E_2_moy_pondere_delta_2041_2070_'+rcp+'_'+saison[s],bbox_inches='tight')
plt.figure(2)
#plot 
delta1=[delta_moyenne_2,delta_moyenne_2p]
delta2=[delta_moy_pond_10000_2,delta_moy_pond_10000_2p]
delta3=[delta_moy_pond_uniforme_2,delta_moy_pond_uniforme_2p] 
delta4=[delta_moy_cmip5_2,delta_moy_cmip5_2p] 
delta5=[delta_moy_cordex_2,delta_moy_cordex_2p] 
delta6=[delta_moy_climex_2,delta_moy_climex_2p]       
legend=['moyenne non pondérée','moy pondérée_bassin<10000km²','moy pondérée_un modèle un vote uniforme','CMIP5','CORDEX']#,'ClimEx']
...
if b_pt=='brute':
   ...
   # plt.savefig('/tank/begin/weighting/plots/brute/pr_tmoy_b_E_2_moy_pondere_delta_2071_2100_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title('Delta entre 1981-2010 et 2071-2100\n'+saison[s]+'_'+rcp+' (E_2)\nPost-traitées')
   # plt.savefig('/tank/begin/weighting/plots/posttraite/pr_tmoy_pt_E_2_moy_pondere_delta_2071_2100_'+rcp+'_'+saison[s],bbox_inches='tight')
