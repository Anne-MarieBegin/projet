...
mean4=[moy_cmip5_1,moy_cmip5_2,moy_cmip5_3]
mean5=[moy_cordex_1,moy_cordex_2,moy_cordex_3]
mean6=[moy_climex_1,moy_climex_2,moy_climex_3]
...
plt.plot(x,mean1,'.',color='m',markersize=12)
plt.plot(x,mean2,'.',color='b',markersize=12)
plt.plot(x,mean3,'.',color='g',markersize=12)
plt.plot(x,mean4,'.',color='c',markersize=12)
plt.plot(x,mean5,'.',color='y',markersize=12)
plt.plot(x,mean6,'.',color='r',markersize=12)
plt.legend(legend)
plt.ylabel('Température ($\circ$C)')
if b_pt=='brute':
    plt.title(var+'_'+saison[s]+'_'+rcp+'\nBrutes')
   # plt.savefig('/tank/begin/weighting/plots/brute/'+var+'_b_moy_pondere_'+rcp+'_'+saison[s],bbox_inches='tight')
else:
    plt.title(var+'_'+saison[s]+'_'+rcp+'\nPost-traitées')
   # plt.savefig('/tank/begin/weighting/plots/posttraite/'+var+'_pt_moy_pondere_'+rcp+'_'+saison[s],bbox_inches='tight')
